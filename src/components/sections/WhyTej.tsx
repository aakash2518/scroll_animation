            ...
            <div className="space-y-12 md:space-y-24 pt-12 lg:pt-32">
              {points.map((pt, i) => (
                <div key={i} className="why-item relative pl-8 md:pl-16 border-l border-white/10 group">
                  <div className="absolute top-0 left-0 w-[2px] h-0 bg-[#4a50c8] group-hover:h-full transition-all duration-700 ease-out"></div>
                  <span className="absolute -left-8 md:-left-12 top-0 text-[#4a50c8] font-mono text-xl md:text-2xl opacity-50 group-hover:opacity-100 transition-opacity">0{i+1}</span>
