        ...
        <div className="container mx-auto px-6 relative z-10 pointer-events-none flex justify-between items-center w-full">
          <div className="max-w-xl w-full">
            <h2 className="font-display font-bold text-4xl text-white mb-16 tracking-wider relative">
              ...
              <motion.div 
                className="absolute -left-6 top-0 w-[2px] bg-[#0077B6]"
            ...
            <div className="relative h-40">
              {steps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    <span className="text-[#0077B6] font-bold text-sm tracking-[0.2em] mb-2">STEP 0{index + 1}</span>
          ...
          <div className="hidden lg:block w-1/3 relative h-64 border border-white/5 rounded-sm p-6 glass-panel">
            <div className="absolute top-4 right-4 flex gap-1">
              <div className="w-1.5 h-1.5 rounded-full bg-[#0077B6] animate-pulse"></div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="w-full h-1 bg-white/10"><div className="w-1/2 h-full bg-[#0077B6]"></div></div>
              </div>
            </div>
          </div>
        </div>
