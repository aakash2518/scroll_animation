  ...
  return (
    <section ref={containerRef} className="relative w-full min-h-[90vh] flex items-center overflow-hidden bg-[#050505]">
      ...
      <div className="container mx-auto px-6 relative z-10 pt-32 pb-20">
        <div className="max-w-3xl">
          <div className="flex items-center gap-4 mb-6 hero-fade opacity-0">
            <div className="w-12 h-[2px] bg-[#4a50c8]"></div>
          ...
          <h1 className="font-display font-black text-6xl md:text-7xl lg:text-8xl leading-[1] tracking-tight mb-6 uppercase">
            ...
            <span className="block text-[#4a50c8] hero-fade opacity-0">What Matters</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-4 hero-fade opacity-0">
            <Link 
              href="#products" 
              className="px-8 py-4 bg-[#4a50c8] hover:bg-[#3d44b0] transition-colors font-bold tracking-widest text-xs text-white uppercase flex items-center gap-2 group"
            >
              OUR SERVICES
            ...
            <Link 
              href="#contact" 
              className="px-8 py-4 border border-white/20 hover:border-[#4a50c8] hover:text-[#4a50c8] transition-colors font-bold tracking-widest text-xs text-white uppercase flex items-center gap-2 group"
            >
              VIEW PROJECTS
              <span className="group-hover:translate-x-1 transition-transform">→</span>
            </Link>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-2 z-10 hero-fade opacity-0">
        <div className="w-8 h-1 bg-[#4a50c8]"></div>
