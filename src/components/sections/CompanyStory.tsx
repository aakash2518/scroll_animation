      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <div className="inline-block mb-4 story-element">
              <div className="flex items-center gap-3">
                <div className="w-10 h-[2px] bg-[#4a50c8]"></div>
                <h4 className="text-[#4a50c8] font-bold tracking-widest text-xs uppercase">About Our Company</h4>
              </div>
            </div>
            ...
            <div>
              <div className="text-lg lg:text-xl text-gray-300 font-light leading-relaxed mb-4 lg:mb-6 border-l-2 border-[#4a50c8]/30 pl-4 lg:pl-6">
          ...
          <div className="w-full lg:w-1/2 relative h-[300px] md:h-[400px] lg:h-[500px] rounded-lg overflow-hidden story-element border border-white/10 group shadow-2xl shadow-black/50">
            ...
            {/* Corner accent */}
            <div className="absolute top-4 left-4 w-8 h-8 border-t-2 border-l-2 border-[#4a50c8] pointer-events-none"></div>
            <div className="absolute bottom-4 right-4 w-8 h-8 border-b-2 border-r-2 border-[#4a50c8] pointer-events-none"></div>
          </div>
