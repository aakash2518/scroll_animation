...
export default function IntroLoader() {
  ...
  return (
    <div className="intro-overlay fixed inset-0 z-[100] bg-[#050505] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#4a50c8]/10 blur-[100px] rounded-full pointer-events-none"></div>
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="w-48 h-[2px] bg-white/10 rounded-full overflow-hidden">
          {/* Animated Bar */}
          <div className="intro-bar w-full h-full bg-[#4a50c8] rounded-full"></div>
        </div>

        {/* Loading Text */}
        <div className="intro-logo mt-4 text-[#4a50c8] font-mono text-[10px] tracking-[0.3em] uppercase">
          Initializing System...
        </div>
      </div>
